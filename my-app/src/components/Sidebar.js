...
const Sidebar = ({ highlights, updateHighlights, currentHighlight, setCurrentHighlight }) => {
  ...
  return (
    <div id="sidebar">
      ...
      <SidebarBody showLoader={showLoader} showAccordion={showAccordion} annotations={annotations} updateAnnotations={updateAnnotations} definitions={definitions} updateDefinitions={updateDefinitions} highlights={highlights} updateHighlights={updateHighlights} currentHighlight={currentHighlight} setCurrentHighlight={setCurrentHighlight} />
      <SidebarFooter />
    </div>
  );
}
