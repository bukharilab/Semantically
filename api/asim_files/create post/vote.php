...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $post_reply_id = $_GET['post_reply_id'];
    $vote = $_GET['vote'];
    ...
    if ($user_id) {
        ...
        // Create document
        $results = mysqli_query($db, sprintf("INSERT INTO `tbl_vote` (user_id, post_reply_id,vote,time_stamp) VALUES ('%s', '%s', '%s','%s')", $user_id, $post_reply_id, $vote,$time_stamp));
