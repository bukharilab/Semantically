...
import {readPost} from '../hooks/documentAPI';

export default function Post() {
  // clear document elements
  const editor = document.querySelector('body > main');
  if (editor) {
    editor.remove();
  ...
  if (!postData) {
    readPost(post_id, updatePostData);
  }
  console.log(postData);

  return (
    <div id="post-panel" className="container">
      <header>
